...
$sql="SELECT * from customer, ticket, booked_leg where ticket.ticket_id=booked_leg.ticket_id and customer.cust_id=ticket.cust_id and customer.fname='$ip_fname'";
