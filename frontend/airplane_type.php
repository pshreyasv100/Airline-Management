...
if ($Insert) {
	echo '<div class="db_form"><form action="airplane_type_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				</br> Company:<input type="text" name="ip_company">
				 </br>Airplane_type: <input type="text" name="ip_type_name">
				 </br>Max_Seats: <input type="text" name="ip_max_seats">
...
if($Delete) {
		echo '<div class="db_form"><form action="airplane_type_delete.php" method="GET">
				 <h1>Please enter the type of the plane to be deleted</h1>
				</br> Type: <input type="text" name="ip_type_name">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
}
