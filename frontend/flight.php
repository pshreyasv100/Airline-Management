...
if ($Insert) {
	echo '<div class="db_form"><form action="flight_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				</br> Flight No.: <input type="text" name="ip_flight_number">
...
if($Delete) {
		echo '<div class="db_form"><form action="flight_delete.php" method="GET">
				 <h1>Please enter the Flight No. to be deleted</h1>
				</br> Flight No.: <input type="text" name="ip_flight_number">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
