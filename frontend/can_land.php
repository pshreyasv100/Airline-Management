...
if ($Insert) {
	echo '<div class="db_form"><form action="can_land_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				 </br>Airplane_type: <input type="text" name="ip_airplane_type">
				 </br>Airport_Code: <input type="text" name="ip_airport_code">
...
if($Delete) {
		echo '<div class="db_form"><form action="can_land_delete.php" method="GET">
				 <h1>Please enter the type of the plane and airport from  to be deleted</h1>
				</br> Type: <input type="text" name="ip_airplane_type">
				</br>Airport_Code: <input type="text" name="ip_airport_code">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
