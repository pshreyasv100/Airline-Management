...
if ($Insert) {
	echo '<div class="db_form"><form action="ticket_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				 </br>Ticket ID : <input type="text" name="ip_ticket_id">
				 </br>Cust ID : <input type="text" name="ip_cust_id">
				 </br>Class  : <input type="text" name="ip_class">
				 </br>Amount   : <input type="text" name="ip_amount"> 
				  </br>Seat NO  : <input type="text" name="ip_seat_no"> 
				   </br>Date(yyyy-mm-dd)  : <input type="text" name="ip_date"> 
...
if($Delete) {
		echo '<div class="db_form"><form action="ticket_delete.php" method="GET">
				 <h1>Please enter Ticket to be deleted</h1>
				</br> Ticket_ID: <input type="text" name="ip_ticket_id">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
}
