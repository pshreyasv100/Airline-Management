...
$sql = "INSERT INTO flight_leg (flight_number,leg_number,departure_airport_code,departure_time,arrival_airport_code,arrival_time)VALUES ('$ip_flight_number','$ip_leg_number','$ip_departure_airport_code','$ip_departure_time','$ip_arrival_airport_code','$ip_arrival_time')";
