...
if ($Insert) {
	echo '<div class="db_form"><form action="airplane_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				</br> ID:<input type="text" name="ip_id">
...
if($Delete) {
		echo '<div class="db_form"><form action="airplane_delete.php" method="GET">
				 <h1>Please insert the id of the plane to be deleted</h1>
				</br> ID: <input type="text" name="ip_id">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
