...
if ($Insert) {
	echo '<div class="db_form"><form action="crew_insert.php" method="GET">
				 <h1> Insert the required feilds</h1>
				</br> SSN:<input type="text" name="ip_SSN">
				 </br>Name: <input type="text" name="ip_Name">
				 </br>Gender: <input type="text" name="ip_Gender">
				 </br>Job: <input type="text" name="ip_Job">
				 </br>Airplane id: <input type="text" name="ip_airplane_id">
...
if($Delete) {
		echo '<div class="db_form"><form action="crew_delete.php" method="GET">
				 <h1>Please enter the SSN of the crew to be deleted</h1>
				</br> SSN: <input type="text" name="ip_SSN">
				 </br><input type="submit" value="Submit">
			</form>
			</div>';
