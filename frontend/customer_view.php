...
if ($result->num_rows > 0) {
    echo '<table><tr><th>first name</th><th>Last Name</th><th>phone_no</th><th>customer id</th></tr>';
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["fname"]."</td><td>".$row["lname"]."</td><td>".$row["phone_no"]."</td><td>".$row["cust_id"]."</td></tr>";
    }
    echo "</table>";
} 
else {
